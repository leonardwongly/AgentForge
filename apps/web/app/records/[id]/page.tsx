    ...
    return (
      <>
        ...
        <section className="page">
          <DataSourceNotice {...data} emptyTitle="Record not found" />
        </section>
      </>
    );
  }
      ...
      <header className="topbar">
        ...
        <div className="control-row">
          ...
          <form action={createRecordExport}>
            <input name="returnTo" type="hidden" value={recordHref(id)} />
...
function recordErrorNotice(error: string): { title: string; detail: string } | undefined {
  switch (error) {
    ...
    default:
      // Unknown values are still rendered only when generated by our bounded
      // server actions; action handlers must pass stable, non-sensitive text.
